...
import style from './internal-txn.module.scss';
                ...
                {data.map(item => {
                    ...
                    return (
                        <div key={hash} className={style.internalTxn__row}>
                            ...
                            <div className={style.internalTxn__column2}>
                                <p className={style.internalTxn__label}>{t('block')}</p>
                                <Link to="/" className={style.internalTxn__link}>
                                    {block}
                                </Link>
                            </div>
                            ...
                            <div className={style.internalTxn__column7}>
                                <p className={style.internalTxn__label}>[Txn {t('fee')}]</p>
                                <p className={style.internalTxn__text}>{fee}</p>
                            </div>
                        </div>
                    );
                })}
